-- Autorregulación en tiempo real para Entrenamiento en Casa (Fase 4)
-- ADITIVO y AISLADO: crea estado y función propios para Casa, sin tocar el motor
-- de HipertrofiaV2 ni los de calistenia/crossfit/funcional/halterofilia.
--
-- Modelo (reps/tiempo + RIR, idéntico a Calistenia/Funcional porque Casa es
-- series×reps×RIR): tras completar una sesión se registra el RIR medio y si se
-- cumplió el objetivo. La función decide el ajuste del próximo microciclo:
...
CREATE TABLE IF NOT EXISTS app.casa_autoreg_state (

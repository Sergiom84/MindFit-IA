const DEFINITIONS = [
  ...
  ["SESSION_COMPLETED", "runtime", "info", "close_session_and_record_result"],
  ["SESSION_CAPPED", "runtime", "info", "close_session_and_preserve_measured_completion"],
  ["SESSION_PARTIAL", "runtime", "warn", "close_session_and_hold_progression"],
  ["SESSION_ABANDONED", "runtime", "warn", "close_session_and_review_cause"],
  ["SESSION_CANCELLED", "runtime", "info", "close_session_without_progression"],

...
/**
 * PR-CAL-01 · Cierre de hallazgos de Codex sobre CAL-01: la IA deja de decidir el nivel,
 * `evaluateCalisteniaLevel` acepta un `assessmentInput` real y devuelve el envelope estable de
 * las 3 decisiones (ok/insufficient_data/refer). userId sintético e inexistente (900099): el
 * perfil se degrada a `null` (getUserFullProfile lanza "Usuario no encontrado", capturado) — el

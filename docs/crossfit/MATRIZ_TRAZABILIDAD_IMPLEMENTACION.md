...
| Evaluación objetiva y confianza    | docs 02/05/17                 | assessment service/UI/ledger/admin           | 32 focalizados; RLS/E2E preparados          | COMPLETADO_GATE_BD_E2E     |
...
| Migración y RLS                    | docs 02/04/08/16              | assessments + catálogo + results/autoreg SQL | estático verde; CI efímero preparado        | PENDIENTE_EJECUCION_CI     |
| Regresión ajena                    | guardas repositorio           | sin cambios en motores ajenos                | 355/355 unit; E2E/golden UI pendiente       | PARCIAL_GATE_E2E           |

...
| Nutricion por nivel/objetivo/carga   | doc 03 + adapter 3x4x3, planned/actual, safety, UI active y compras V2                 | flag off; migración/BD/shadow/dietista pendientes |
| Flujos plan/single-day/player        | docs 05/17 + adaptadores + cierre terminal y draft durable                             | código cerrado; BD/E2E real pendientes            |

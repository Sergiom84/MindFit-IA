/**
 * @fileoverview Índice de componentes para TodayTrainingTab
 * 
 * Exporta todos los componentes modulares del TodayTrainingTab
 * 
 * @module components/routines/tabs/TodayTrainingTab/components
 */

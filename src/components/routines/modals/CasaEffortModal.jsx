...
/**
 * Auto-evaluación de esfuerzo al completar una sesión de Entrenamiento en Casa.
 * Captura el RIR medio (repeticiones en reserva) y si se cumplió el objetivo,
 * que alimentan la autorregulación (POST /methodology-session/casa/session-result).
 * Mismo modelo que Calistenia/Funcional (series×reps×RIR).
 */
const RIR_OPTIONS = [
...
export default function CasaEffortModal({ isOpen, onSubmit, onSkip, onContinue, result = null, isLoading = false }) {

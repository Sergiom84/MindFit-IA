...
/**
 * Auto-evaluación de esfuerzo al completar una sesión de Halterofilia.
 * Disciplina de FUERZA: captura el RPE (1-10), si se alcanzó la CARGA objetivo y
 * si la TÉCNICA fue sólida, que alimentan la autorregulación de carga
 * (POST /methodology-session/halterofilia/session-result).
 * Equivalente a CrossFitEffortModal pero con el modelo RPE + carga + técnica.
 */
const RPE_OPTIONS = [
...
export default function HalterofiliaEffortModal({
  isOpen,
  onSubmit,
  onSkip,
  onContinue,
    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/70 p-4">
      <div className="w-full max-w-md rounded-2xl border border-white/10 border-l-2 border-l-yellow-400/40 bg-neutral-900/95 shadow-2xl backdrop-blur-xl">
        ...
        <div className="space-y-5 px-6 py-5">
          ...
          <div>
            <p className="mb-2 text-sm font-semibold text-gray-200">¿La técnica se mantuvo sólida?</p>
            <div className="flex gap-2">
              <button
